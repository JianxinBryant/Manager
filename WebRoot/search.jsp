  ...
  <body>
    <div class="container">
		...
		href="meeting.jsp">发布会议</a></li>
					<li role="presentation" class="active" style="font-size:20px"><a href="search.jsp">查看会议</a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
					...
					<form action="SearchMeetingServlet" method="post" style="width: 1023px; height: 396px">
					<select id="select" name="select">
            <option value=1>按会议编号查询</option>
            <option value=2>按会议名称查询</option>
            <option value=3>按会议地址查询</option></select>
            ...
            <input type="submit" value="查 询" class="btn btn-warning"/>
                      ...
                      <br>
                      			...
                      			参与人数：<input type="text" name="NumberofParticipants" value="${requestScope.NumberofParticipants}" /><span >（人数不能超过50人）</span>
                                                          会议日期：<input type="text" name="MeetingDate" value="${requestScope.MeetingDate}" />
                     ...
                     <br>
								...
								<a href="UpdateShowAllMServlet?MeetingID=${requestScope.MeetingID}">修改</a>
