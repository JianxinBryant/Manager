...
public class CodeController {
    private int width = 146;//验证码宽度
    private int height = 65;//验证码高度
    private int codeCount = 4;//验证码个数
    private int lineCount = 30;//混淆线个数
    private int fontSize = 60; //字体大小
    private int codeS = 28; //验证码间距
    private int codeTop = 45; //验证码于上底边距
    private int codeLeft = 20;//验证码于左底边距
